...
export const PAYS = {
  ...
  ch: {
    ...
    categories: ["via-ferrata", "randonnee", "refuge", "camping", "grotte", "lac", "cascade",
                 "chateau", "cite-caractere", "culture", "panorama", "sommet-croix", "col-mythique", "phare", "arbre-remarquable", "plongee", "saut-eau", "ciel-etoile", "cascade-glace", "vidange", "aire-repos", "toilettes", "eau"],
  ...
  pt: {
    ...
    categories: ["chateau", "cite-caractere", "grotte", "lac", "cascade", "camping",
                 "refuge", "via-ferrata", "culture", "panorama", "sommet-croix", "col-mythique", "phare", "arbre-remarquable", "plongee", "saut-eau", "ciel-etoile", "vidange", "aire-repos", "toilettes", "eau"],
  ...
  de: {
    ...
    categories: ["via-ferrata", "refuge", "camping", "grotte", "lac", "cascade",
                 "chateau", "culture", "panorama", "sommet-croix", "col-mythique", "phare", "arbre-remarquable", "plongee", "ciel-etoile", "cascade-glace", "vidange", "aire-repos", "toilettes", "eau"],
  ...
  nl: {
    ...
    categories: ["camping", "grotte", "lac", "cascade", "chateau", "culture", "panorama", "phare", "arbre-remarquable", "plongee", "ciel-etoile", "vidange", "aire-repos", "toilettes", "eau"],
  ...
  lu: {
    ...
    gr: null,
    categories: ["camping", "grotte", "lac", "cascade", "chateau", "culture", "panorama", "arbre-remarquable", "plongee", "vidange", "aire-repos", "toilettes", "eau"],
  ...
  be: {
    ...
    categories: ["chateau", "cite-caractere", "grotte", "cascade", "lac", "camping",
                 "refuge", "via-ferrata", "culture", "panorama", "col-mythique", "phare", "arbre-remarquable", "plongee", "ciel-etoile", "vidange", "aire-repos", "toilettes", "eau"],
  ...
  nz: {
    ...
    categories: ["via-ferrata", "randonnee", "refuge", "camping", "grotte", "lac", "cascade",
                 "chateau", "cathedrale", "cite-caractere", "culture", "cascade-glace", "vidange", "aire-repos", "toilettes", "eau"],
