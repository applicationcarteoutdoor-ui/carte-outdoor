...
export const PAYS = {
  ...
  ch: {
    ...
    categories: ["via-ferrata", "randonnee", "refuge", "camping", "grotte", "lac", "cascade",
                 "chateau", "cite-caractere", "culture", "panorama", "sommet-croix", "col-mythique", "phare", "arbre-remarquable", "plongee", "ciel-etoile", "cascade-glace", "vidange", "toilettes", "eau"],
  ...
  pt: {
    ...
    categories: ["chateau", "cite-caractere", "grotte", "lac", "cascade", "camping",
                 "refuge", "via-ferrata", "culture", "panorama", "sommet-croix", "col-mythique", "phare", "arbre-remarquable", "plongee", "ciel-etoile", "vidange", "toilettes", "eau"],
