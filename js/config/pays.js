...
export const PAYS = {
  ...
  ch: {
    ...
    categories: ["via-ferrata", "randonnee", "refuge", "camping", "grotte", "lac", "cascade",
                 "chateau", "cite-caractere", "culture", "panorama", "sommet-croix", "col-mythique", "phare", "arbre-remarquable", "plongee", "ciel-etoile", "toilettes", "eau"],
  ...
  pt: {
    ...
    categories: ["chateau", "cite-caractere", "grotte", "lac", "cascade", "camping",
                 "refuge", "via-ferrata", "culture", "panorama", "sommet-croix", "col-mythique", "phare", "arbre-remarquable", "plongee", "ciel-etoile", "toilettes", "eau"],
  ...
  de: {
    ...
    categories: ["via-ferrata", "refuge", "camping", "grotte", "lac", "cascade",
                 "chateau", "culture", "panorama", "sommet-croix", "col-mythique", "phare", "arbre-remarquable", "plongee", "ciel-etoile", "toilettes", "eau"],
  ...
  nl: {
    ...
    categories: ["camping", "grotte", "lac", "cascade", "chateau", "culture", "panorama", "phare", "arbre-remarquable", "plongee", "ciel-etoile", "toilettes", "eau"],
  ...
  lu: {
    ...
    gr: null,
    categories: ["camping", "grotte", "lac", "cascade", "chateau", "culture", "panorama", "arbre-remarquable", "plongee", "toilettes", "eau"],
  ...
  be: {
    ...
    categories: ["chateau", "cite-caractere", "grotte", "cascade", "lac", "camping",
                 "refuge", "via-ferrata", "culture", "panorama", "col-mythique", "phare", "arbre-remarquable", "plongee", "ciel-etoile", "toilettes", "eau"],
