    ...
    filters: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: "Écrins", icon: "⛰️" },
          { value: "Dévoluy", icon: "⛰️" },
          { value: "Queyras", icon: "⛰️" },
          { value: "Ubaye", icon: "⛰️" },
          { value: "Mercantour", icon: "⛰️" },
          { value: "Verdon", icon: "⛰️" },
          { value: "Provence", icon: "⛰️" },
          { value: "Pays basque-Béarn", icon: "⛰️" },
          { value: "Bigorre", icon: "⛰️" },
          { value: "Luchonnais", icon: "⛰️" },
          { value: "Ariège", icon: "⛰️" },
          { value: "Pyrénées-Orientales", icon: "⛰️" },
          { value: "Jura", icon: "⛰️" },
          { value: "Vosges", icon: "⛰️" },
          { value: "Sancy", icon: "⛰️" },
          { value: "Chaîne des Puys", icon: "⛰️" },
          { value: "Cantal", icon: "⛰️" },
          { value: "Cévennes", icon: "⛰️" },
          { value: "Mézenc", icon: "⛰️" },
          { value: "Corse", icon: "⛰️" },
        ],
      },
